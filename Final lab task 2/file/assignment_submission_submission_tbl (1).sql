...
--
-- Host: 127.0.0.1    Database: assignment_submission
-- ------------------------------------------------------
...
CREATE TABLE `submission_tbl` (
  ...
  CONSTRAINT `submission_tbl_ibfk_2` FOREIGN KEY (`shortname`) REFERENCES `assignment_tbl` (`shortname`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-04-22 13:27:58
